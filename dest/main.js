...
const menuMobile = document.querySelector(
  ".main__slider .slider__fixed .menu__homepage"
);
const menuMobileHover = document.querySelector(
  ".main__slider .slider__fixed .menu__homepage-hover"
);
...
const navMenu = document.querySelector(
  ".main__slider .slider__fixed .nav__menu"
);
...
const closeBtn = document.querySelector(
  ".main__slider .slider__fixed .nav__menu .nav__content .nav__icon .close__btn"
);
...
const left = document.querySelector(
  "header .main__header-mobile .container__mobile .left"
);
const navmenuMobile = document.querySelector(
  "header .main__header-mobile .container__mobile .left .sub__nav-menu .nav__menu"
);
...
const backToTop = document.querySelector(
  "footer .footer__homepage .container .backtotop"
);
...
const btnPrev = document.querySelector(
  ".main__slider .slider__fixed .btn__ctrl-slider .btn__prev"
);
const btnNext = document.querySelector(
  ".main__slider .slider__fixed .btn__ctrl-slider .btn__next"
);
